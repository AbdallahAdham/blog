...
---
![missions](img/RCT_CERT/mission.JPG)

---
## *1-Something Suspicious*

![smth_sus](img/RCT_CERT/Smth_sus.JPG)
...
![ftp_log](img/RCT_CERT/ftp_log.JPG)
...
![base64_dec](img/RCT_CERT/base64_dec.JPG)
 ...
 ![base64_dec2](img/RCT_CERT/base64_dec2.JPG)
...
## *2-Decrypting the payload*
 ...
 ![Decrypt_pay](img/RCT_CERT/Decrypt_pay.JPG)
...
![olevba](img/RCT_CERT/olevba.JPG)
...
![olevba2](img/RCT_CERT/olevba2.JPG)
...
![locked_out](img/RCT_CERT/locked_out.JPG)
...
![lockedout](img/RCT_CERT/lockedout.JPG)
...
![jenkins](img/RCT_CERT/jenkins.JPG)
...
![jenkins2](img/RCT_CERT/jenkins2.JPG)
...
![jenkins3](img/RCT_CERT/jenkins3.JPG)
...
![jenkins4](img/RCT_CERT/jenkins4.JPG)

Wow! Is This a **Script console**, We are getting closer and closer :grin:.

![jenkins5](img/RCT_CERT/jenkins5.JPG)
...
![jenkins6](img/RCT_CERT/jenkins6.JPG)
...
![listener](img/RCT_CERT/listener.JPG)
...
![change_locks](img/RCT_CERT/change_locks.JPG)
...
![python](img/RCT_CERT/python.JPG)
...
![brainfuck](img/RCT_CERT/brainfuck.JPG)
...
![redis1](img/RCT_CERT/redis1.JPG)
...
![redis2](img/RCT_CERT/redis2.JPG)
...
![redis6](img/RCT_CERT/redis6.JPG)

Yes, we are now hype :partying_face:.

![redis7](img/RCT_CERT/redis7.JPG)

Now let's head to **/home/hype** and see what is inside!

![redis8](img/RCT_CERT/redis8.JPG)

Let's see what is inside **user.txt** ?

It is the flag!

![redis9](img/RCT_CERT/redis9.JPG)
...
![crown_jewels](img/RCT_CERT/crown_jewels.JPG)
...
![locate_hacker](img/RCT_CERT/locate_hacker.JPG)
...
![hacker1](img/RCT_CERT/hacker1.JPG)
...
![hacker2](img/RCT_CERT/hacker2.JPG)
...
![hacker3](img/RCT_CERT/hacker3.JPG)

Yes, We found it!

![hacker4](img/RCT_CERT/hacker4.JPG)
...
![hacker5](img/RCT_CERT/hacker5.JPG)
...
![hacker6](img/RCT_CERT/hacker6.JPG)
...
![hacker7](img/RCT_CERT/hacker7.JPG)
...
![hacker8](img/RCT_CERT/hacker8.JPG)
...
![crime_pay](img/RCT_CERT/crime_pay.JPG)
